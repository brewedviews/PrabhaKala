    ...
    <section className="relative py-20 md:py-32 bg-brand-charcoal text-brand-cream overflow-hidden">
      <div className="container">
        <motion.div {...reveal(0)} className="text-center max-w-3xl mx-auto mb-4">
          <div className="text-xs tracking-[0.4em] uppercase text-brand-gold-light mb-6">Our Craft</div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div {...reveal(0.2)} className="relative">
            <div className="relative aspect-[4/5] overflow-hidden">
              <img src={WEAVE_IMG} alt="Handloom weaving in progress" className="w-full h-full object-cover" />
            </div>
          ...
          <motion.div {...reveal(0.35)}>
            <p className="text-brand-cream/80 leading-relaxed mb-4">
              We don't stick to one region, one weave, or one weaver. Banarasi from Varanasi.
              Kanjivaram from Kanchipuram. Organza, cotton, and everything between — each piece
              sourced from artisans who've spent their lives mastering exactly that craft.
            </p>
            <p className="text-brand-cream/80 leading-relaxed mb-10">
              No middlemen, no mass production. Every saree comes straight from the loom to
              you — pure silk, real zari, made by hands that know the difference.
            </p>

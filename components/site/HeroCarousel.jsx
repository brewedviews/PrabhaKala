...
const SLIDES = [
  {
    ...
    text: "Real zari. Real silk. Sourced from the weavers who've spent lifetimes perfecting it — not a factory in sight.",
  ...
  },
  {
    ...
    heading: 'Kanjivaram,',
    headingAccent: 'Rewritten.',
    text: "Vivid silk. Bold zari. Made for brides who don't do boring.",
  ...
  },
  {
    ...
    headingAccent: 'Zero Repeats.',
    text: 'One for the sangeet. One for the pheras. Every occasion, sorted.',
